            ...
            {foreach from=$rees46_products item='product' name=product}
                <li class="clearfix">
                    <a class="products-block-image" href="{$product.link|escape:'htmlall':'UTF-8'}">
                        <img src="{$product.image|escape:'htmlall':'UTF-8'}" alt="{$product.name|escape:'htmlall':'UTF-8'}" title="{$product.name|escape:'htmlall':'UTF-8'}" class="replace-2x img-responsive"/>
                    </a>
                    <div class="product-content">
                        ...
                        <p class="product-description">{$product.description_short|escape:'htmlall':'UTF-8'}</p>
